...
scripts/autoregressive/torchrun.sh test_net.py --vq-ckpt pretrained_models/vfmtok-tokenizer.pt            \
    --gpt-ckpt snapshot/${model_type}/${model_type}-$1e.pt --compile --gpt-model ${model_type} --image-size 336 \
